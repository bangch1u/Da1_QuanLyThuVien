...
select * from LichSuNap
delete from TacGiaSach
delete from TacGia
delete from ChiTietTheLoai
delete from TheLoai
delete from ThietHaiChiTiet
delete from ThietHai
delete from PhieuMuonChiTiet
delete from PhieuTraSach
delete from PhieuMuon
delete from LichSuNap
delete from TheThuVien
delete from SachChiTiet
delete from Sach
